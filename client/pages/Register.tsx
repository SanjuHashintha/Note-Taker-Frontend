...
import { User, Mail, Eye, EyeOff, BookOpen, Loader2, Building, Sparkles, GraduationCap } from 'lucide-react';
    ...
    try {
      ...
      navigate('/login', {
        state: {
          ...
          registeredUser: formData.username
        }
      });
    } catch (error) {
              ...
              <form onSubmit={handleSubmit}>
                <CardContent className="relative space-y-6">
                  ...
                  >
                    ...
                    <div className="relative group">
                      ...
                      >
                        <SelectTrigger className="pl-11 h-12 bg-white/10 border-white/20 text-white focus:border-gold-400 focus:ring-gold-400/20 backdrop-blur-sm">
                          <SelectValue placeholder="Select your university" className="text-white/50" />
                        </SelectTrigger>
                        <SelectContent className="bg-navy-800/95 border-white/20 backdrop-blur-xl">
                          {universities.map((uni) => (
                            <SelectItem key={uni} value={uni} className="text-white hover:bg-white/10">
                              {uni}
                            </SelectItem>
                          ))}
                        </SelectContent>
                    ...
                    {errors.university && (
                      <p className="text-xs text-red-300">{errors.university}</p>
                    )}
                  </motion.div>
