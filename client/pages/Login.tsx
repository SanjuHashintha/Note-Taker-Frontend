...
import { Mail, Lock, Eye, EyeOff, BookOpen, Loader2, Sparkles, GraduationCap, Shield } from 'lucide-react';
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const userData = {
      ...
      role: formData.email.toLowerCase().includes('admin') ? 'Admin' : 'Student',
      firstName: formData.email.toLowerCase().includes('admin') ? 'Admin' : 'John',
      lastName: formData.email.toLowerCase().includes('admin') ? 'User' : 'Doe',
