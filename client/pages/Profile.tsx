      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold text-navy-950">Profile Settings</h1>
                ...
                <Card className="bg-white/80 backdrop-blur-sm border-navy-200">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="flex items-center space-x-6">
                      ...
                      <div>
                        <Label htmlFor="picture" className="text-navy-700 font-medium">
                          Profile Picture
                        </Label>
                        <div className="flex items-center space-x-3 mt-2">
                          ...
                          <span className="text-sm text-navy-500">
                            {profileData.profilePicture ? profileData.profilePicture.name : 'No file selected'}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="firstName" className="text-navy-700 font-medium">
                          First Name
                        </Label>
                        <Input
                          id="firstName"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="lastName" className="text-navy-700 font-medium">
                          Last Name
                        </Label>
                        <Input
                          id="lastName"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="university" className="text-navy-700 font-medium">
                        University
                      </Label>
                      <div className="relative">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label className="text-navy-700 font-medium">Role</Label>
                ...
                <Card className="bg-white/80 backdrop-blur-sm border-navy-200">
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="currentPassword" className="text-navy-700 font-medium">
                          Current Password
                        </Label>
                        <div className="relative">
                          <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="newPassword" className="text-navy-700 font-medium">
                          New Password
                        </Label>
                        <div className="relative">
                          <Input
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-navy-500">Receive notifications about shared notes and updates</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-navy-500">Get notified instantly on your device</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label className="text-navy-700 font-medium">Share by Default</Label>
                          <p className="text-sm text-navy-500">Make new notes shareable by default</p>
                        </div>
                        <Switch
                      ...
                      <div className="space-y-2">
                        <Label className="text-navy-700 font-medium">Theme</Label>
                        <Select 
                      ...
                      <div className="space-y-2">
                        <Label className="text-navy-700 font-medium">Language</Label>
                        <Select 
                ...
                <div className="space-y-6">
                  <Card className="bg-white/80 backdrop-blur-sm border-navy-200">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Download all your data including notes, categories, and tags
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <Button
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  All your notes, categories, tags, and shared content will be permanently deleted.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
